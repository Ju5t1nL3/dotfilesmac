...
# alias for c++ compiling
alias cmpl="g++ -std=c++17 -Wall -Wextra -pedantic-errors -Weffc++ -Wno-unused-parameter -fsanitize=undefined *.cpp" alias run="./a.out"
...
alias skhdconfig="code ~/.config/skhd/skhdrc"
